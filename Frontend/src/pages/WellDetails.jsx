        ...
        <div className="max-w-6xl mx-auto">
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center space-x-4">
                  <div className="bg-opacity-20 p-4 rounded-lg">
                    <FiFile className="text-white" size={60} />
                  </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <button
              onClick={handleAnalyze}
              disabled={selectedCurves.length === 0}
              className="mt-5 w-full inline-flex items-center justify-center px-6 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
              AI Analysis{" "}
              {selectedCurves.length > 0
                ? `(${selectedCurves.length} curves selected)`
                : "— select curves above"}
            </button>
          </div>
